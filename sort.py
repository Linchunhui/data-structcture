...
if __name__=="__main__":
    ...
    #list.appendleft(0)
    #print(sort.bubbleSort(list))
    #print(sort.selectSort(list))
    #print(sort.insertSort(list))
    #print(sort.shellSort(list))
    #print(sort.mergeSort2(list))
    #print(sort.quickSort2(list))
    #print(sort.heapSort1(list))
    print(sort.radix_sort(list))